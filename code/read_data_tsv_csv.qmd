...
nsf_2014_2019 <- read_tsv('../data/NSF_all_grants_2019-2014.tsv', col_types = col_spec)
nsf_2020_2026 <- read_tsv('../data/NSF_all_grants_2026-2020.tsv', col_types = col_spec)
...
nsf_cut = readr::read_csv('../data_raw/grant_witness_nsf_terminations.csv')
...
nsf_cut2 = readr::read_csv('../data_raw/NSF-Terminated-Awards.csv')
...
```{r, export NSF scientist emails}
# Combine all into a single string, comma-separated
all_emails <- paste(nsf_all$pi_emails, collapse = ", ")

# Write to a text file
writeLines(all_emails, "emails_for_email.txt")
```
...
nih = readr::read_csv('../data_raw/grant_witness_nih_terminations.csv')
epa = readr::read_csv('../data_raw/grant_witness_epa_terminations.csv')
...
nih_all_2025 = readr::read_csv('../data_raw/nih_reporter_all_grants_2025_USA.csv', skip = 5)
nih_all_2024 = readr::read_csv('../data_raw/nih_reporter_all_grants_2024_USA.csv', skip = 5)
nih_all_2023 = readr::read_csv('../data_raw/nih_reporter_all_grants_2023_USA.csv', skip = 5)
nih_all_2022 = readr::read_csv('../data_raw/nih_reporter_all_grants_2022_USA.csv', skip = 5)
nih_all_2021 = readr::read_csv('../data_raw/nih_reporter_all_grants_2021_USA.csv', skip = 5)
