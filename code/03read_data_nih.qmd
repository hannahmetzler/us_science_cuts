...
# To reload: 
#nih_exporter_usa <- readRDS(here("data/nih_exporter_usa_2014_2024.rds"))
```
...
# To reload: 
# nih_2025_all <- readRDS(here("data/nih_2025_manual.rds"))
```
...
# To reload: 
nih_exporter_usa <- readRDS(here("data/nih_exporter_usa_2014_2025.rds"))
```
