...
# Get column names from each year - step not necessary
col_names_list <- lapply(nih_exporter_list, names)

# Find common columns across all years - step not necessary
common_cols <- Reduce(intersect, col_names_list)
cat("Common columns across all years:", length(common_cols), "\n")

# Combine using only common columns for safety - adapt if you delete steps above
...
# Save checkpoint: ExPORTER 2014-2024 data
