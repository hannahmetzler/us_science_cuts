...
# Load the final analysis dataset if it exists (run the code below only if you need to regenerate it)
parquet_file <- here('data_analysis/nsf_analysis.parquet')

if (file.exists(parquet_file)) {
  nsf_analysis <- arrow::read_parquet(parquet_file)
  cat("Loaded NSF analysis dataset:", nrow(nsf_analysis), "grants,", ncol(nsf_analysis), "columns\n")
  glimpse(nsf_analysis)
} else {
  cat("No cached data found. Run the sections below to create nsf_analysis.\n")
}
``` 
...
arrow::write_parquet(nsf_analysis, here('data_analysis/nsf_analysis.parquet'))
cat("NSF analysis dataset:", nrow(nsf_analysis), "grants,", ncol(nsf_analysis), "columns\n")
cat("Saved to data_analysis/nsf_analysis.csv and .parquet\n")
glimpse(nsf_analysis)
```
